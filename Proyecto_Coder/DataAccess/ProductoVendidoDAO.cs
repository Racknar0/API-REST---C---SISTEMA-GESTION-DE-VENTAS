...
{
    internal class ProductoVendidoDAO
    {
        ...
        public int AddProductoVendido(ProductoVendido productoVendido)
        {
        ...
        public ProductoVendido UpdateProductoVendido(ProductoVendido productoVendido)
        {
        ...
        public int DeleteProductoVendido(int id)
        {
